...
<nav class="relative w-full flex items-center justify-center px-[75px]">
    <div class="fixed top-0 flex items-center justify-between w-full max-w-[1130px] rounded-3xl p-4 bg-white mt-[30px] z-30">
        <a href="index.html" class="flex shrink-0">
            <img src="assets/images/logos/logo-black.svg" alt="logo">
        </a>
...
<header class="relative flex flex-col w-full h-[712px]">
    <div class="absolute w-full h-[650px] overflow-hidden">
        <img src="assets/images/backgrounds/hero-image.webp" class="w-full h-full object-cover" alt="hero image">
    ...
    <form action="search-result.html" class="relative flex w-full max-w-[940px] rounded-3xl p-5 gap-5 bg-white border border-outline shadow-[0px_8px_30px_0px_#06092208] mx-auto mt-auto">
...
<section id="Popular-Categories" class="flex flex-col w-full mt-[70px] gap-[30px]">
    <div class="flex flex-col w-full max-w-[1280px] px-[75px] mx-auto">
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="group rounded-full border border-primary py-[14px] px-5 hover:bg-primary flex items-center transition-all duration-300">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide !w-fit py-0.5 first-of-type:pl-[calc(((100%-1280px)/2)+75px)] last-of-type:pr-[calc(((100%-1280px)/2)+75px)]">
                <a href="category.html" class="card">
                    <div class="flex flex-col w-[240px] shrink-0 rounded-[30px] ring-1 ring-outline bg-white p-[10px] gap-4 hover:ring-2 hover:ring-info transition-all duration-300">
                        <div class="flex w-full h-[240px] overflow-hidden rounded-[30px]">
                            <img src="assets/images/thumbnails/thumbnails-1.png" class="w-full h-full object-cover" alt="thumbnails">
                        </div>
                        <div class="flex flex-col gap-2 pb-[10px] pl-[10px]">
                            <h3 class="font-bold text-lg">Beaches</h3>
                            <div class="flex items-center gap-[6px]">
                                <img src="assets/images/icons/house-2.svg" class="size-5 flex shrink-0" alt="icon">
            ...
            <div class="swiper-slide !w-fit py-0.5 first-of-type:pl-[calc(((100%-1280px)/2)+75px)] last-of-type:pr-[calc(((100%-1280px)/2)+75px)]">
                <a href="category.html" class="card">
                    <div class="flex flex-col w-[240px] shrink-0 rounded-[30px] ring-1 ring-outline bg-white p-[10px] gap-4 hover:ring-2 hover:ring-info transition-all duration-300">
                        <div class="flex w-full h-[240px] overflow-hidden rounded-[30px]">
                            <img src="assets/images/thumbnails/thumbnails-2.png" class="w-full h-full object-cover" alt="thumbnails">
                        </div>
                        <div class="flex flex-col gap-2 pb-[10px] pl-[10px]">
                            <h3 class="font-bold text-lg">Beaches</h3>
                            <div class="flex items-center gap-[6px]">
            ...
            <div class="swiper-slide !w-fit py-0.5 first-of-type:pl-[calc(((100%-1280px)/2)+75px)] last-of-type:pr-[calc(((100%-1280px)/2)+75px)]">
                <a href="category.html" class="card">
                    <div class="flex flex-col w-[240px] shrink-0 rounded-[30px] ring-1 ring-outline bg-white p-[10px] gap-4 hover:ring-2 hover:ring-info transition-all duration-300">
                        <div class="flex w-full h-[240px] overflow-hidden rounded-[30px]">
                            <img src="assets/images/thumbnails/thumbnails-3.png" class="w-full h-full object-cover" alt="thumbnails">
                        </div>
                        <div class="flex flex-col gap-2 pb-[10px] pl-[10px]">
                            <h3 class="font-bold text-lg">Beaches</h3>
                            <div class="flex items-center gap-[6px]">
            ...
            <div class="swiper-slide !w-fit py-0.5 first-of-type:pl-[calc(((100%-1280px)/2)+75px)] last-of-type:pr-[calc(((100%-1280px)/2)+75px)]">
                <a href="category.html" class="card">
                    <div class="flex flex-col w-[240px] shrink-0 rounded-[30px] ring-1 ring-outline bg-white p-[10px] gap-4 hover:ring-2 hover:ring-info transition-all duration-300">
                        <div class="flex w-full h-[240px] overflow-hidden rounded-[30px]">
                            <img src="assets/images/thumbnails/thumbnails-4.png" class="w-full h-full object-cover" alt="thumbnails">
                        </div>
                        <div class="flex flex-col gap-2 pb-[10px] pl-[10px]">
                            <h3 class="font-bold text-lg">Beaches</h3>
                            <div class="flex items-center gap-[6px]">
        ...
        <div class="slider slide-up w-[230px] h-max flex flex-col flex-nowrap shrink-0">
            <div class="h-max">
                <div class="content flex flex-col gap-[30px] pt-[30px]">
                    <div class="testimonial-card flex flex-col w-full rounded-[30px] border border-outline bg-white p-4 gap-[14px]">
                        <div class="flex">
                        ...
                        <div class="flex items-center gap-[14px]">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-secondary">House Designer</p>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-card flex flex-col w-full rounded-[30px] border border-outline bg-white p-4 gap-[14px]">
                        ...
                        <div class="flex items-center gap-[14px]">
                            <div class="flex size-[60px] rounded-full overflow-hidden">
                                <img src="assets/images/photos/profile-2.png" class="w-full h-full object-cover" alt="photo profile">
                            </div>
                            <div>
                                <p class="font-semibold">Sarina Dwi</p>
                                <p class="text-sm text-secondary">House Designer</p>
                    ...
                    <div class="testimonial-card flex flex-col w-full rounded-[30px] border border-outline bg-white p-4 gap-[14px]">
                        ...
                        <div class="flex items-center gap-[14px]">
                            <div class="flex size-[60px] rounded-full overflow-hidden">
                                <img src="assets/images/photos/profile-3.png" class="w-full h-full object-cover" alt="photo profile">
                            </div>
                            <div>
                                <p class="font-semibold">Sarina Dwi</p>
                                <p class="text-sm text-secondary">House Designer</p>
                    ...
                    <div class="testimonial-card flex flex-col w-full rounded-[30px] border border-outline bg-white p-4 gap-[14px]">
                        ...
                        <div class="flex items-center gap-[14px]">
                            <div class="flex size-[60px] rounded-full overflow-hidden">
                                <img src="assets/images/photos/profile-4.png" class="w-full h-full object-cover" alt="photo profile">
                            </div>
                            <div>
                                <p class="font-semibold">Sarina Dwi</p>
                                <p class="text-sm text-secondary">House Designer</p>
                    ...
                    <div class="testimonial-card flex flex-col w-full rounded-[30px] border border-outline bg-white p-4 gap-[14px]">
                        ...
                        <div class="flex items-center gap-[14px]">
                            <div class="flex size-[60px] rounded-full overflow-hidden">
                                <img src="assets/images/photos/profile-5.png" class="w-full h-full object-cover" alt="photo profile">
                            </div>
                            <div>
                                <p class="font-semibold">Sarina Dwi</p>
                                <p class="text-sm text-secondary">House Designer</p>
